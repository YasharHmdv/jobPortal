...
public class DjinniScraperService {
    ...
    private List<Job> scrapeJobs(WebDriver driver) {
        ...
        for (int page = 1; page <= maxPages; page++) {
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(".list-jobs__item")));
            
            // Find all job listings
            List<WebElement> jobElements = driver.findElements(By.cssSelector(".list-jobs__item"));
            ...
            if (jobElements.size() < jobsPerPage) {
                break;
            }
        }
